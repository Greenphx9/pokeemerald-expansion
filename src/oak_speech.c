...
#define OAK_SKIP_CONTROLS_PAGE FALSE
...
// strings
static const u8 sOtherText_NewName[] = _("New Name");
static const u8 sNameChoice_Green[] = _("Green");
static const u8 sNameChoice_Red[] = _("Red");
static const u8 sNameChoice_Leaf[] = _("Leaf");
...
static const u8 sControlsGuide_Text_Intro[] = _("The various buttons will be explained in\nthe order of their importance.");
static const u8 sControlsGuide_Text_DPad[] = _("Moves the main character.\nAlso used to choose various data\nheadings.");
static const u8 sControlsGuide_Text_AButton[] = _("Used to confirm a choice, check\nthings, chat, and scroll text.");
static const u8 sControlsGuide_Text_BButton[] = _("Used to exit, cancel a choice,\nand cancel a mode.");
static const u8 sControlsGuide_Text_StartButton[] = _("Press this button to open the\nmenu.");
static const u8 sControlsGuide_Text_SelectButton[] = _("Used to shift items and to use\na registered item.");
static const u8 sControlsGuide_Text_LRButtons[] = _("If you need help playing the\ngame, or on how to do things,\npress the L or R Button.");
static const u8 sOakSpeech_Text_AskPlayerGender[] = _("Now tell me. Are you a boy?\nOr are you a girl?");
static const u8 sPikachuIntro_Text_Page1[] = _("In the world which you are about to\nenter, you will embark on a grand\nadventure with you as the hero.\n\nSpeak to people and check things\nwherever you go, be it towns, roads,\nor caves. Gather information and\nhints from every source.");
static const u8 sPikachuIntro_Text_Page2[] = _("New paths will open to you by helping\npeople in need, overcoming challenges,\nand solving mysteries.\n\nAt times, you will be challenged by\nothers and attacked by wild creatures.\nBe brave and keep pushing on.");
static const u8 sPikachuIntro_Text_Page3[] = _("Through your adventure, we hope\nthat you will interact with all sorts\nof people and achieve personal growth.\nThat is our biggest objective.\n\nPress the A Button, and let your\nadventure begin!");
static const u8 sOakSpeech_Text_WelcomeToTheWorld[] = _("Hello, there!\nGlad to meet you!\pWelcome to the world of Pokemon!\pMy name is Oak.\pPeople affectionately refer to me\nas the Pokemon Professor.\p");
static const u8 sOakSpeech_Text_ThisWorld[] = _("This world…");
static const u8 sOakSpeech_Text_IsInhabitedFarAndWide[] = _("…is inhabited far and wide by\ncreatures called Pokemon.\p");
static const u8 sOakSpeech_Text_IStudyPokemon[] = _("For some people, Pokemon are pets.\nOthers use them for battling.\pAs for myself…\pI study Pokemon as a profession.\p");
static const u8 sOakSpeech_Text_TellMeALittleAboutYourself[] = _("But first, tell me a little about\nyourself.\p");
static const u8 sOakSpeech_Text_YourNameWhatIsIt[] = _("Let's begin with your name.\nWhat is it?\p");
static const u8 sOakSpeech_Text_SoYourNameIsPlayer[] = _("Right…\nSo your name is {PLAYER}.");
static const u8 sOakSpeech_Text_WhatWasHisName[] = _("This is my grandson.\pHe's been your rival since you both\nwere babies.\p…Erm, what was his name now?");
static const u8 sOakSpeech_Text_YourRivalsNameWhatWasIt[] = _("Your rival's name, what was it now?");
static const u8 sOakSpeech_Text_ConfirmRivalName[] = _("…Er, was it {RIVAL}?");
static const u8 sOakSpeech_Text_RememberRivalsName[] = _("That's right! I remember now!\nHis name is {RIVAL}!\p");
static const u8 sOakSpeech_Text_LetsGo[] = _("{PLAYER}!\pYour very own Pokemon legend is\nabout to unfold!\pA world of dreams and adventures\nwith Pokemon awaits! Let's go!");
...
{
    [PIKACHU_INTRO_PAGE_1] = sPikachuIntro_Text_Page1,
    [PIKACHU_INTRO_PAGE_2] = sPikachuIntro_Text_Page2,
    [PIKACHU_INTRO_PAGE_3] = sPikachuIntro_Text_Page3
};
...
{
    // Page 2
    sControlsGuide_Text_DPad,
    sControlsGuide_Text_AButton,
    sControlsGuide_Text_BButton,
    // Page 3
    sControlsGuide_Text_StartButton,
    sControlsGuide_Text_SelectButton,
    sControlsGuide_Text_LRButtons
};
...
static void Task_NewGameScene(u8 taskId)
{
    ...
    case 1:
        ...
        CreateMonSpritesGfxManager(MON_SPR_GFX_MANAGER_A, MON_SPR_GFX_MODE_BATTLE);
        break;
    case 2:
    ...
    case 6:
        ...
        break;
    case 7:
        HofPCTopBar_AddWindow(0, 30, 0, 13, 0x1C4, TRUE);
        FillBgTilemapBufferRect_Palette0(1, 0xD00F, 0,  0, 30, 2);
        FillBgTilemapBufferRect_Palette0(1, 0xD002, 0,  2, 30, 1);
        FillBgTilemapBufferRect_Palette0(1, 0xD00E, 0, 19, 30, 1);
        #if OAK_SKIP_CONTROLS_PAGE == FALSE
    ...
    case 10:
        ...
        #if OAK_SKIP_CONTROLS_PAGE == TRUE
...
static void ControlsGuide_LoadPage1(void)
{
    ...
    AddTextPrinterParameterized4(sOakSpeechResources->windowIds[0], FONT_SHORT, 2, 0, 1, 1, sTextColor_White, 0, sControlsGuide_Text_Intro);
...
static void Task_ControlsGuide_LoadPage(u8 taskId)
{
    ...
    else
    {
        ...
        for (currWindow = CONTROLS_GUIDE_PAGES_2_3_WINDOW_TOP; currWindow < NUM_CONTROLS_GUIDE_PAGES_2_3_WINDOWS; currWindow++)
        {
            ...
            AddTextPrinterParameterized4(sOakSpeechResources->windowIds[currWindow], FONT_SHORT, 6, 0, 1, 1, sTextColor_White, 0, sControlsGuide_Pages2And3_Strings[currWindow + page2Or3 * CONTROLS_GUIDE_STRINGS_PER_PAGE]);
...
#define OakSpeechPrintMessage(str, speed) ({                                                                                                                 \
    ...
    if (StringCompare(str, gStringVar4) == 0)                                                                                                                \
    {                                                                                                                                                        \
        StringExpandPlaceholders(gStringVar4, str);                                                                                                          \
        AddTextPrinterParameterized2(WIN_INTRO_TEXTBOX, FONT_SHORT, gStringVar4, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY); \
    }                                                                                                                                                        \
    else                                                                                                                                                     \
    {                                                                                                                                                        \
        AddTextPrinterParameterized2(WIN_INTRO_TEXTBOX, FONT_SHORT, str, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);         \
    }                                                                                                                                                        \
...
static void Task_OakSpeech_WelcomeToTheWorld(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        {
            OakSpeechPrintMessage(sOakSpeech_Text_WelcomeToTheWorld, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_ThisWorld(u8 taskId)
{
    ...
    {
        OakSpeechPrintMessage(sOakSpeech_Text_ThisWorld, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_IsInhabitedFarAndWide(u8 taskId)
{
    ...
    if (gTasks[taskId].tTimer < 0x4000)
    {
        ...
        {
            OakSpeechPrintMessage(sOakSpeech_Text_IsInhabitedFarAndWide, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_IStudyPokemon(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        OakSpeechPrintMessage(sOakSpeech_Text_IStudyPokemon, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_TellMeALittleAboutYourself(u8 taskId)
{
    ...
    else
    {
        ...
        {
            OakSpeechPrintMessage(sOakSpeech_Text_TellMeALittleAboutYourself, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_AskPlayerGender(u8 taskId)
{
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        else
        {
            tTrainerPicPosX = -60;
            ClearTrainerPic();
            OakSpeechPrintMessage(sOakSpeech_Text_AskPlayerGender, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_ShowGenderOptions(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_SHORT, 8, 1, sOakSpeechResources->textColor, 0, sText_Boy);
        sOakSpeechResources->textColor[0] = 1;
        sOakSpeechResources->textColor[1] = 2;
        sOakSpeechResources->textColor[2] = 3;
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_SHORT, 8, 17, sOakSpeechResources->textColor, 0, sText_Girl);
        InitMenuNormal(gTasks[taskId].tMenuWindowId, FONT_SHORT, 0, 1, GetFontAttribute(FONT_SHORT, FONTATTR_MAX_LETTER_HEIGHT) + 2, 2, 0);
...
static void Task_OakSpeech_YourNameWhatIsIt(u8 taskId)
{
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        {
            tTrainerPicPosX = 0;
            OakSpeechPrintMessage(sOakSpeech_Text_YourNameWhatIsIt, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_RepeatNameQuestion(u8 taskId)
{
    ...
    if (sOakSpeechResources->hasPlayerBeenNamed == FALSE)
        OakSpeechPrintMessage(sOakSpeech_Text_YourNameWhatIsIt, 0);
    else
        OakSpeechPrintMessage(sOakSpeech_Text_YourRivalsNameWhatWasIt, 0);
    gTasks[taskId].func = Task_OakSpeech_HandleRivalNameInput;
}
...
static void Task_OakSpeech_ConfirmName(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        {
            if (sOakSpeechResources->hasPlayerBeenNamed == FALSE)
                StringExpandPlaceholders(gStringVar4, sOakSpeech_Text_SoYourNameIsPlayer);
            else
                StringExpandPlaceholders(gStringVar4, sOakSpeech_Text_ConfirmRivalName);
        ...
        else if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
        {
            ...
            {
                CreateYesNoMenuAtPos(&sIntro_WindowTemplates[WIN_INTRO_YESNO], FONT_SHORT, 0, 2, GetStandardFrameBaseTileNum(), 14, 0);
...
static void Task_OakSpeech_HandleConfirmNameInput(u8 taskId)
{
    ...
    case 0: // YES
        ...
        {
            StringExpandPlaceholders(gStringVar4, sOakSpeech_Text_RememberRivalsName);
            OakSpeechPrintMessage(gStringVar4, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_AskRivalsName(u8 taskId)
{
    ...
    if (tTrainerPicFadeState != 0)
    {
        OakSpeechPrintMessage(sOakSpeech_Text_WhatWasHisName, sOakSpeechResources->textSpeed);
...
static void Task_OakSpeech_LetsGo(u8 taskId)
{
    ...
    {
        StringExpandPlaceholders(gStringVar4, sOakSpeech_Text_LetsGo);
        OakSpeechPrintMessage(gStringVar4, sOakSpeechResources->textSpeed);
        gTasks[taskId].tTimer = 30;
...
static void CreateNidoranFSprite(u8 taskId)
{
    ...
    LoadSpecialPokePic(MonSpritesGfxManager_GetSpritePtr(MON_SPR_GFX_MANAGER_A, 0), INTRO_SPECIES, 0x0, TRUE);
    LoadSpritePaletteWithTag(gSpeciesInfo[INTRO_SPECIES].palette, INTRO_SPECIES);
...
static void PrintNameChoiceOptions(u8 taskId, u8 hasPlayerBeenNamed)
{
    ...
    FillWindowPixelBuffer(gTasks[taskId].tMenuWindowId, PIXEL_FILL(1));
    AddTextPrinterParameterized(tMenuWindowId, FONT_SHORT, sOtherText_NewName, 8, 1, 0, NULL);
    ...
    for (i = 0; i < ARRAY_COUNT(sRivalNameChoices); i++)
        AddTextPrinterParameterized(tMenuWindowId, FONT_SHORT, textPtrs[i], 8, 16 * (i + 1) + 1, 0, NULL);
    InitMenuNormal(tMenuWindowId, FONT_SHORT, 0, 1, 16, 5, 0);
