...
u32 GetBoxMonData3(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    switch (field)
    {
        ...
        case MON_DATA_SHEEN:
            break;
        case MON_DATA_HP_WANTED_EV:
            retVal = boxMon->hpWantedEV;
            break;          
        case MON_DATA_ATK_WANTED_EV:
            retVal = boxMon->attackWantedEV;
            break;   
        case MON_DATA_DEF_WANTED_EV:
            retVal = boxMon->defenseWantedEV;
            break; 
        case MON_DATA_SPEED_WANTED_EV:
            retVal = boxMon->speedWantedEV;
            break; 
        case MON_DATA_SPATK_WANTED_EV:
            retVal = boxMon->spAttackWantedEV;
            break; 
        case MON_DATA_SPDEF_WANTED_EV:
            retVal = boxMon->spDefenseWantedEV;
            break; 
...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    switch (field)
    {
        ...
        case MON_DATA_SHEEN:
            break;
        case MON_DATA_HP_WANTED_EV:
            SET8(boxMon->hpWantedEV);
            break;          
        case MON_DATA_ATK_WANTED_EV:
            SET8(boxMon->attackWantedEV);
            break;   
        case MON_DATA_DEF_WANTED_EV:
            SET8(boxMon->defenseWantedEV);
            break; 
        case MON_DATA_SPEED_WANTED_EV:
            SET8(boxMon->speedWantedEV);
            break; 
        case MON_DATA_SPATK_WANTED_EV:
            SET8(boxMon->spAttackWantedEV);
            break; 
        case MON_DATA_SPDEF_WANTED_EV:
            SET8(boxMon->spDefenseWantedEV);
            break; 
        case MON_DATA_POKERUS:
            break;
        case MON_DATA_MET_LOCATION:
