...
const struct BattleBackground sBattleTerrainTable[] =
{
    ...
    {
        .tileset = gBattleTerrainTiles_DPPTGrass_Day,
        .tilemap = gBattleTerrainTilemap_DPPTGrass_Day,
        .entryTileset = gBattleTerrainAnimTiles_DPPTGrass,
        .entryTilemap = gBattleTerrainAnimTilemap_DPPTGrass,
        .palette = gBattleTerrainPalette_DPPTGrass_Day,
        .afternoonTileset = gBattleTerrainTiles_DPPTGrass_Afternoon,
        .afternoonTilemap = gBattleTerrainTilemap_DPPTGrass_Afternoon,
        .afternoonPal = gBattleTerrainPalette_DPPTGrass_Afternoon,
        .nightTileset = gBattleTerrainTiles_DPPTGrass_Night,
        .nightTilemap = gBattleTerrainTilemap_DPPTGrass_Night,
        .nightPal = gBattleTerrainPalette_DPPTGrass_Night,
    },
    ...
    {
        .tileset = gBattleTerrainTiles_DPPTWater_Day,
        .tilemap = gBattleTerrainTilemap_DPPTWater_Day,
        .entryTileset = gBattleTerrainAnimTiles_DPPTWater,
        .entryTilemap = gBattleTerrainAnimTilemap_DPPTWater,
        .palette = gBattleTerrainPalette_DPPTWater_Day,
    ...
    [BATTLE_TERRAIN_POND] =
    {
        .tileset = gBattleTerrainTiles_DPPTWetPath_Day,
        .tilemap = gBattleTerrainTilemap_DPPTWetPath_Day,
        .entryTileset = gBattleTerrainAnimTiles_DPPTWetPath,
        .entryTilemap = gBattleTerrainAnimTilemap_DPPTWetPath,
        .palette = gBattleTerrainPalette_DPPTWetPath_Day,
        .afternoonTileset = gBattleTerrainTiles_DPPTWetPath_Afternoon,
        .afternoonTilemap = gBattleTerrainTilemap_DPPTWetPath_Afternoon,
        .afternoonPal = gBattleTerrainPalette_DPPTWetPath_Afternoon,
    },

    [BATTLE_TERRAIN_MOUNTAIN] =
    {
        .tileset = gBattleTerrainTiles_DPPTMountain_Day,
        .tilemap = gBattleTerrainTilemap_DPPTMountain_Day,
        .entryTileset = gBattleTerrainAnimTiles_DPPTMountain,
        .entryTilemap = gBattleTerrainAnimTilemap_DPPTMountain,
        .palette = gBattleTerrainPalette_DPPTMountain_Day,
        .afternoonTileset = gBattleTerrainTiles_DPPTMountain_Afternoon,
        .afternoonTilemap = gBattleTerrainTilemap_DPPTMountain_Afternoon,
        .afternoonPal = gBattleTerrainPalette_DPPTMountain_Afternoon,
        .nightTileset = gBattleTerrainTiles_DPPTMountain_Night,
        .nightTilemap = gBattleTerrainTilemap_DPPTMountain_Night,
        .nightPal = gBattleTerrainPalette_DPPTMountain_Night,
    },

    [BATTLE_TERRAIN_CAVE] =
    {
        .tileset = gBattleTerrainTiles_DPPTCave_1,
        .tilemap = gBattleTerrainTilemap_DPPTCave_1,
        .entryTileset = gBattleTerrainAnimTiles_DPPTCave,
        .entryTilemap = gBattleTerrainAnimTilemap_DPPTCave,
        .palette = gBattleTerrainPalette_DPPTCave_1,
    },
...
void DrawMainBattleBackground(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
    {
        ...
        case SPECIES_RAYQUAZA:
            ...
            break;
        default:
            LZDecompressVram(GetBattleBGTileset(time, BATTLE_TERRAIN_POND), (void *)(BG_CHAR_ADDR(2)));
            LZDecompressVram(GetBattleBGTilemap(time, BATTLE_TERRAIN_POND), (void *)(BG_SCREEN_ADDR(26)));
            LoadCompressedPalette(GetBattleBGPal(time, BATTLE_TERRAIN_POND), BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
            break;
        }
    }
    else
...
void DrawBattleEntryBackground(void)
{
    ...
    else
    {
        ...
        {
            LZDecompressVram(sBattleTerrainTable[BATTLE_TERRAIN_POND].entryTileset, (void *)(BG_CHAR_ADDR(1)));
            LZDecompressVram(sBattleTerrainTable[BATTLE_TERRAIN_POND].entryTilemap, (void *)(BG_SCREEN_ADDR(28)));
        }
        else
        {
            LZDecompressVram(gBattleTerrainAnimTiles_Building, (void *)(BG_CHAR_ADDR(1)));
