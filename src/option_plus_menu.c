...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_CANCEL]      = sText_OptionMenuSave,
};
...
static void DrawDescriptionText(void)
{
    ...
    AddTextPrinterParameterized4(WIN_DESCRIPTION, FONT_SHORT, 8, 1, 0, 0, color_gray, TEXT_SKIP_DRAW, OptionTextDescription());
...
static void DrawLeftSideOptionText(int selection, int y)
{
    ...
    if (CheckConditions(selection))
        AddTextPrinterParameterized4(WIN_OPTIONS, FONT_SHORT, 8, y, 0, 0, color_yellow, TEXT_SKIP_DRAW, OptionTextRight(selection));
    else
        AddTextPrinterParameterized4(WIN_OPTIONS, FONT_SHORT, 8, y, 0, 0, color_gray, TEXT_SKIP_DRAW, OptionTextRight(selection));
}
...
static void DrawRightSideChoiceText(const u8 *text, int x, int y, bool8 choosen, bool8 active)
{
    ...
    if (choosen)
        AddTextPrinterParameterized4(WIN_OPTIONS, FONT_SHORT, x, y, 0, 0, color_red, TEXT_SKIP_DRAW, text);
    else
        AddTextPrinterParameterized4(WIN_OPTIONS, FONT_SHORT, x, y, 0, 0, color_gray, TEXT_SKIP_DRAW, text);
}
...
static void DrawChoices_TextSpeed(int selection, int y)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(FONT_SHORT, gText_TextSpeedFast, 198), y, styles[2], active);
}
...
static void DrawChoices_BattleScene(int selection, int y)
{
    ...
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(FONT_SHORT, gText_BattleSceneOff, 198), y, styles[1], active);
}
...
static void DrawChoices_BattleStyle(int selection, int y)
{
    ...
    DrawOptionMenuChoice(gText_BattleStyleSet, GetStringRightAlignXOffset(FONT_SHORT, gText_BattleStyleSet, 198), y, styles[1], active);
}
...
static void DrawChoices_Sound(int selection, int y)
{
    ...
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(FONT_SHORT, gText_SoundStereo, 198), y, styles[1], active);
}
...
static const u8 sText_EM[] = _("RSE");
static const u8 sText_DPPT[] = _("DPPT");
static const u8 sText_HGSS[] = _("HGSS");
static const u8 *const sMusicOptions[] = {sText_FRLG, sText_EM, sText_DPPT, sText_HGSS};
static void DrawChoices_WildMusic(int selection, int y)
{
