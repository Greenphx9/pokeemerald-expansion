...
static void LoadAllContestMonIconPalettes(void)
{
    ...
    {
        species = gContestMons[i].species;
        LoadCompressedPalette(GetMonSpritePalFromSpeciesAndPersonality(species, gContestMons[i].isShiny, gContestMons[i].personality), BG_PLTT_ID(10 + i), PLTT_SIZE_4BPP);
    }
}
