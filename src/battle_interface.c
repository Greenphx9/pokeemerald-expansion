...
s32 MoveBattleBar(u8 battlerId, u8 healthboxSpriteId, u8 whichBar, u8 unused)
{
    ...
    {
        u16 hpFraction = gSaveBlock2Ptr->optionsFastHP == 0 ? 1 : max(gBattleSpritesDataPtr->battleBars[battlerId].maxValue / (B_HEALTHBAR_PIXELS / 2), 1);
...
static u8 GetScaledExpFraction(s32 oldValue, s32 receivedValue, s32 maxValue, u8 scale)
{
    ...
    scale *= (gSaveBlock2Ptr->optionsFastEXP == 1) ? 2 : 8;
