...
static void Task_StarterChoose(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, FONT_SHORT, gText_BirchInTrouble, 0, 1, 0, NULL);
    PutWindowTilemap(0);
...
static void Task_AskConfirmStarter(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, FONT_SHORT, gText_ConfirmStarterChoice, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
...
static void CreateStarterPokemonLabel(u8 selection)
{
    ...
    width = GetStringCenterAlignXOffset(FONT_SHORT, speciesName, 0x68);
    AddTextPrinterParameterized3(sStarterLabelWindowId, FONT_SHORT, width, 17, sTextColors, 0, speciesName);
