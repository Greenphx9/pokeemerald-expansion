...
#define MAX_DEFAULT_WALLPAPER  WALLPAPER_CAVE
#define START_RANDOM_WALLPAPER WALLPAPER_SPACE
#define END_RANDOM_WALLPAPER   WALLPAPER_REVIVAL
#define RANDOM_WALLPAPER_COUNT END_RANDOM_WALLPAPER - START_RANDOM_WALLPAPER
