const struct Ability gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    [ABILITY_STENCH] =
    {
        ...
        .longDescription = COMPOUND_STRING("Attacks may cause a foe to\nflinch."),
        .aiRating = 1,
    },
    ...
    [ABILITY_SPEED_BOOST] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Speed at the end of each\nturn."),
        .aiRating = 9,
    },
    ...
    [ABILITY_STATIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("May paralyse attackers that make\ncontact."),
        .aiRating = 4,
    },
    ...
    [ABILITY_VOLT_ABSORB] =
    {
        ...
        .longDescription = COMPOUND_STRING("Restores HP if hit by Electric\nmoves."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WATER_ABSORB] =
    {
        ...
        .longDescription = COMPOUND_STRING("Restores HP if hit by Water\nmoves."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_SUCTION_CUPS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Prevents being forced to switch\nout."),
        .aiRating = 2,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WONDER_GUARD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Only supereffective moves can\ndeal damage."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .breakable = TRUE,
    ...
    [ABILITY_EFFECT_SPORE] =
    {
        ...
        .longDescription = COMPOUND_STRING("May inflict poison, paralysis,\nor sleep on contact."),
        .aiRating = 4,
    },
    ...
    [ABILITY_SYNCHRONIZE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Shares status conditions with foe."),
        .aiRating = 4,
    },
    ...
    [ABILITY_CLEAR_BODY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Prevents its stats from being\nlowered."),
        .aiRating = 4,
        .breakable = TRUE,
    },
    ...
    [ABILITY_NATURAL_CURE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Status conditions are cured\non switching out."),
        .aiRating = 7,
    },
    ...
    [ABILITY_LIGHTNING_ROD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Draws in Electric moves.\nBoosts Sp. Atk instead."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_SERENE_GRACE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Raises chance of additional\neffects occurring."),
        .aiRating = 8,
    },
    ...
    [ABILITY_TRACE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Copies an opposing Pokémon's\nAbility."),
        .aiRating = 6,
        .cantBeCopied = TRUE,
        .cantBeTraced = TRUE,
    },
    ...
    [ABILITY_POISON_POINT] =
    {
        ...
        .longDescription = COMPOUND_STRING("May poison attackers that make\ncontact."),
        .aiRating = 4,
    },
    ...
    [ABILITY_SOUNDPROOF] =
    {
        ...
        .longDescription = COMPOUND_STRING("Immune to all sound-based\nmoves."),
        .aiRating = 4,
        .breakable = TRUE,
    },
    ...
    [ABILITY_THICK_FAT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Halves damage from Fire and Ice\nmoves."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_FLAME_BODY] =
    {
        ...
        .longDescription = COMPOUND_STRING("May burn attackers that make\ncontact."),
        .aiRating = 4,
    },
    ...
    [ABILITY_RUN_AWAY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Ensures escape from wild\nPokémon and being trapped."),
        .aiRating = 0,
    },
    ...
    [ABILITY_TRUANT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Acts only every other turn.\nOtherwise, loafs around."),
        .aiRating = -2,
    ...
    [ABILITY_HUSTLE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Attack, but lowers\naccuracy."),
        .aiRating = 7,
    },
    ...
    [ABILITY_CUTE_CHARM] =
    {
        ...
        .longDescription = COMPOUND_STRING("May infatuate foes that make\ncontact."),
        .aiRating = 2,
    },
    ...
    [ABILITY_PLUS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Sp. Atk if an ally has\nPlus or Minus"),
        .aiRating = 0,
    },
    ...
    [ABILITY_SHED_SKIN] =
    {
        ...
        .longDescription = COMPOUND_STRING("May cure its status by shedding\nskin."),
        .aiRating = 7,
    },
    ...
    [ABILITY_GUTS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Attack if affected by a\nstatus condition."),
        .aiRating = 6,
    },
    ...
    [ABILITY_MARVEL_SCALE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Defense if affected by a\nstatus condition."),
        .aiRating = 5,
        .breakable = TRUE,
    },
    ...
    [ABILITY_LIQUID_OOZE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Hurts foes using draining or\nleeching moves."),
        .aiRating = 3,
    },
    ...
    [ABILITY_MOTOR_DRIVE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Immune to Electric moves.\nBoosts Speed instead."),
        .aiRating = 6,
        .breakable = TRUE,
    },
    ...
    [ABILITY_RIVALRY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Ups damage to same-gendered\nfoes. Less to opposite genders."),
        .aiRating = 1,
    },
    ...
    [ABILITY_HEATPROOF] =
    {
        ...
        .longDescription = COMPOUND_STRING("Halves damage from Fire-type\nmoves."),
        .aiRating = 5,
        .breakable = TRUE,
    },
    ...
    [ABILITY_SIMPLE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Doubles the effects of stat\nchanges."),
        .aiRating = 8,
        .breakable = TRUE,
    },
    ...
    [ABILITY_DRY_SKIN] =
    {
        ...
        .longDescription = COMPOUND_STRING("Heals in rain and from Water.\nWeak to sun and Fire."),
        .aiRating = 6,
        .breakable = TRUE,
    },
    ...
    [ABILITY_DOWNLOAD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Raises Atk or Sp. Atk based on\nfoe's defenses."),
        .aiRating = 7,
    },
    ...
    [ABILITY_SKILL_LINK] =
    {
        ...
        .longDescription = COMPOUND_STRING("Multi-hit moves always hit the\nmaximum times."),
        .aiRating = 7,
    },
    ...
    [ABILITY_SOLAR_POWER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Sp. Atk in sun, but HP\ndrops every turn."),
        .aiRating = 3,
    },
    ...
    [ABILITY_QUICK_FEET] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Speed if affected by a\nstatus condition."),
        .aiRating = 5,
    },
    ...
    [ABILITY_NORMALIZE] =
    {
        ...
        .longDescription = COMPOUND_STRING("All moves become Normal and\nget a slight power boost."),
        .aiRating = -1,
    },
    ...
    [ABILITY_SNIPER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Critical hits deal even more\ndamage."),
        .aiRating = 3,
    },
    ...
    [ABILITY_MAGIC_GUARD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Only takes damage from attacks."),
        .aiRating = 9,
    },
    ...
    [ABILITY_TINTED_LENS] =
    {
        ...
        .longDescription = COMPOUND_STRING("“Not very effective” moves deal\nmore damage."),
        .aiRating = 7,
    },
    ...
    [ABILITY_SLOW_START] =
    {
        ...
        .longDescription = COMPOUND_STRING("Attack and Speed are halved for\nfive turns."),
        .aiRating = -2,
    },
    ...
    [ABILITY_SCRAPPY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Can hit Ghost types with Normal\nand Fighting moves."),
        .aiRating = 6,
    },
    ...
    [ABILITY_FRISK] =
    {
        ...
        .longDescription = COMPOUND_STRING("Reveals a foe's held item on\nentering battle."),
        .aiRating = 3,
    },
    ...
    [ABILITY_FLOWER_VEIL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Protects ally Grass types from\nstatus and stat drops."),
        .aiRating = 0,
    },
    ...
    [ABILITY_FUR_COAT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Halves damage from physical\nmoves."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_BULLETPROOF] =
    {
        ...
        .longDescription = COMPOUND_STRING("Protects from ball and bomb\nmoves."),
        .aiRating = 7,
    },
    ...
    [ABILITY_STRONG_JAW] =
    {
        ...
        .longDescription = COMPOUND_STRING("Powers up the Pokémon's biting\nmoves."),
        .aiRating = 6,
    },
    ...
    [ABILITY_SWEET_VEIL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Prevents the Pokémon and allies\nfrom falling asleep."),
        .aiRating = 4,
        .breakable = TRUE,
    },
    ...
    [ABILITY_STANCE_CHANGE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Switches among Blade and Shield\nFormes when it attacks or guards."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_GALE_WINGS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Flying moves get priority while\nits HP is full."),
        .aiRating = 6,
    },
    ...
    [ABILITY_GRASS_PELT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Defense while on Grassy\nTerrain."),
        .aiRating = 2,
        .breakable = TRUE,
    },
    ...
    [ABILITY_TOUGH_CLAWS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Powers up moves that make\ndirect contact."),
        .aiRating = 7,
    },
    ...
    [ABILITY_PIXILATE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Normal moves become Fairy\nand get a slight power boost."),
        .aiRating = 8,
    },
    ...
    [ABILITY_AERILATE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Normal moves become Flying\nand get a slight power boost."),
        .aiRating = 8,
    },
    ...
    [ABILITY_AURA_BREAK] =
    {
        ...
        .longDescription = COMPOUND_STRING("Reverses Aura Abilities, weakening\nthose move types instead."),
        .aiRating = 3,
    },
    ...
    [ABILITY_DESOLATE_LAND] =
    {
        ...
        .longDescription = COMPOUND_STRING("Summons intense sunlight that\nnullifies Water-type attacks."),
        .aiRating = 10,
    },
    ...
    [ABILITY_DELTA_STREAM] =
    {
        ...
        .longDescription = COMPOUND_STRING("Removes Flying's weaknesses with\nmysterious winds."),
        .aiRating = 10,
    },
    ...
    [ABILITY_SEED_SOWER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Creates Grassy Terrain when hit\nby an attack."),
        .aiRating = 5,
    },
    ...
    [ABILITY_THERMAL_EXCHANGE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Attack when hit by Fire.\nIt cannot be burned."),
        .aiRating = 4,
        .breakable = TRUE,
    },
    ...
    [ABILITY_ANGER_SHELL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Below half HP, lowers defenses\nbut boosts offensive stats."),
        .aiRating = 3,
    },
    ...
    [ABILITY_PURIFYING_SALT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Prevents status and halves\ndamage from Ghost moves."),
        .aiRating = 6,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WELL_BAKED_BODY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Takes no damage from Fire.\nSharply boosts Defense."),
        .aiRating = 5,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WIND_RIDER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Attack from wind or\nTailwind. Also has immunity."),
        .aiRating = 4,
        .breakable = TRUE,
    },
    ...
    [ABILITY_GUARD_DOG] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts Attack if intimidated.\nPrevents forced switching."),
        .aiRating = 5,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WIND_POWER] =
    {
        ...
        .longDescription = COMPOUND_STRING("When hit by wind, it charges up,\nboosting its next Electric move."),
        .aiRating = 4,
    },
    ...
    [ABILITY_ZERO_TO_HERO] =
    {
        ...
        .longDescription = COMPOUND_STRING("Switching out transforms it into\nHero Form."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_PROTOSYNTHESIS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts best stat in harsh sunlight\nor with Booster Energy."),
        .aiRating = 7,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_QUARK_DRIVE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Boosts best stat on Electric\nTerrain or with Booster Energy."),
        .aiRating = 7,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_GOOD_AS_GOLD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Grants full immunity to all\nstatus moves from other Pokémon."),
        .aiRating = 8,
        .breakable = TRUE,
    },
    ...
    [ABILITY_VESSEL_OF_RUIN] =
    {
        ...
        .description = COMPOUND_STRING("Lowers foes' Sp. Attack."),
        .aiRating = 5,
        .breakable = TRUE,
    },
    ...
    [ABILITY_ORICHALCUM_PULSE] =
    {
        ...
        .description = COMPOUND_STRING("Summons sunlight in battle."),
        .longDescription = COMPOUND_STRING("Summons harsh sunlight and\nboosts Attack in sunlight."),
        .aiRating = 8,
    },
    ...
    [ABILITY_HADRON_ENGINE] =
    {
        ...
        .description = COMPOUND_STRING("Field becomes Electric."),
        .longDescription = COMPOUND_STRING("Creates Electric Terrain and\nboosts Sp. Atk in that terrain."),
        .aiRating = 8,
    },
    ...
    [ABILITY_OPPORTUNIST] =
    {
        ...
        .longDescription = COMPOUND_STRING("When a foe's stat is boosted,\nthe same stat is boosted for it."),
        .aiRating = 5,
    },
    ...
    [ABILITY_CUD_CHEW] =
    {
        ...
        .longDescription = COMPOUND_STRING("After eating a Berry, it eats\nthe same Berry again next turn."),
        .aiRating = 4,
    },
    ...
    [ABILITY_SUPREME_OVERLORD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Attack and Sp. Atk are boosted\nbased on fainted allies."),
        .aiRating = 6,
    },
    ...
    [ABILITY_COSTAR] =
    {
        ...
        .longDescription = COMPOUND_STRING("Copies ally's stat changes when\nit enters the battle."),
        .aiRating = 5,
    },
    ...
    [ABILITY_TOXIC_DEBRIS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Scatters Toxic Spikes when hit\nby a physical move."),
        .aiRating = 4,
    },
    ...
    [ABILITY_EARTH_EATER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Restores HP instead of taking\ndamage from Ground-type moves."),
        .aiRating = 7,
        .breakable = TRUE,
    },
    ...
    [ABILITY_MYCELIUM_MIGHT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Status moves go last but ignore\nthe target’s Ability."),
        .aiRating = 2,
    },
    ...
    [ABILITY_HOSPITALITY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Restores ally's HP when it\nenters the battle."),
        .aiRating = 5,
    },
    ...
    [ABILITY_MINDS_EYE] =
    {
        ...
        .longDescription = COMPOUND_STRING("Ignores evasion. Can hit Ghosts\nwith Normal and Fighting moves."),
        .aiRating = 8,
        .breakable = TRUE,
    },
    ...
    [ABILITY_EMBODY_ASPECT_TEAL_MASK] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Teal Mask shines, boosting\nthe Pokémon's Speed stat."),
        .aiRating = 6,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK] =
    {
        .name = _("Embody Aspect"),
        .description = COMPOUND_STRING("Raises Attack."),
        .longDescription = COMPOUND_STRING("The Hearthflame Mask shines,\nboosting Attack stat."),
        .aiRating = 6,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_EMBODY_ASPECT_WELLSPRING_MASK] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Wellspring Mask shines,\nboosting Sp. Def stat."),
        .aiRating = 6,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK] =
    {
        .name = _("Embody Aspect"),
        .description = COMPOUND_STRING("Raises Defense."),
        .longDescription = COMPOUND_STRING("The Cornerstone Mask shines,\nboosting Defense stat."),
        .aiRating = 6,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_TOXIC_CHAIN] =
    {
        ...
        .longDescription = COMPOUND_STRING("May badly poison the target\nwhen the Pokémon uses a move."),
        .aiRating = 8,
    },
    ...
    [ABILITY_SUPERSWEET_SYRUP] =
    {
        ...
        .longDescription = COMPOUND_STRING("Lowers opposing evasiveness\nwhen it enters the battle."),
        .aiRating = 5,
    },
    ...
    [ABILITY_TERA_SHIFT] =
    {
        ...
        .longDescription = COMPOUND_STRING("Transforms into Terastal Form\nwhen it enters the battle."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_TERA_SHELL] =
    {
        ...
        .longDescription = COMPOUND_STRING("If HP is full, moves that hit\nare not very effective."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_TERAFORM_ZERO] =
    {
        ...
        .longDescription = COMPOUND_STRING("Removes all weather and terrain\nwhen it becomes Stellar Form."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_POISON_PUPPETEER] =
    {
        ...
        .longDescription = COMPOUND_STRING("Moves that poison also cause\nconfusion to affected targets."),
        .aiRating = 8,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
