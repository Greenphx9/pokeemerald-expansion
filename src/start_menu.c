...
static void ShowSafariBallsWindow(void)
{
    ...
    AddTextPrinterParameterized(sSafariBallsWindowId, FONT_SHORT, gStringVar4, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void ShowPyramidFloorWindow(void)
{
    ...
    AddTextPrinterParameterized(sBattlePyramidFloorWindowId, FONT_SHORT, gStringVar4, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        else
        {
            ...
            AddTextPrinterParameterized(GetStartMenuWindowId(), FONT_SHORT, gStringVar4, 8, (index << 4) + 9, TEXT_SKIP_DRAW, NULL);
        }
...
static bool32 InitStartMenuStep(void)
{
    ...
    case 4:
        ...
        break;
    case 5:
        sStartMenuCursorPos = InitMenuNormal(GetStartMenuWindowId(), FONT_SHORT, 0, 9, 16, sNumStartMenuActions, sStartMenuCursorPos);
...
void ShowStartMenu(void)
{
    ...
    CreateTask(Task_ShowStartMenu, 0);
    LockPlayerFieldControls();
}
