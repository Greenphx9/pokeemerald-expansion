...
static const u16 sFrontierBrainTrainerIds[NUM_FRONTIER_FACILITIES] =
{
    ...
    [FRONTIER_FACILITY_DOME]    = TRAINER_NONE,
    [FRONTIER_FACILITY_PALACE]  = TRAINER_NONE,
    [FRONTIER_FACILITY_ARENA]   = TRAINER_NONE,
    [FRONTIER_FACILITY_FACTORY] = TRAINER_NONE,
    [FRONTIER_FACILITY_PIKE]    = TRAINER_NONE,
    [FRONTIER_FACILITY_PYRAMID] = TRAINER_NONE,
};
