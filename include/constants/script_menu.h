...
#define STDSTRING_ITEMS_POCKET     30
#define STDSTRING_KEY_ITEMS_POCKET 31
#define STDSTRING_POKEBALLS_POCKET 32
#define STDSTRING_TM_CASE          33
#define STDSTRING_BERRY_POUCH      34
