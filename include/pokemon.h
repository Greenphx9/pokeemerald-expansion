...
enum {
    ...
    MON_DATA_HP_WANTED_EV,
    MON_DATA_ATK_WANTED_EV,
    MON_DATA_DEF_WANTED_EV,
    MON_DATA_SPEED_WANTED_EV,
    MON_DATA_SPATK_WANTED_EV,
    MON_DATA_SPDEF_WANTED_EV,
};
...
struct BoxPokemon
{
    ...
    u8 spDefenseEV;
    u32 hpWantedEV:6;
    u32 attackWantedEV:6;
    u32 defenseWantedEV:6;
    u32 speedWantedEV:6;
    u32 spAttackWantedEV:6;
    u8 unused_01:2;
    u8 spDefenseWantedEV;
