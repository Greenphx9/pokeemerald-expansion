...
#define FREE_RIBBONS                        TRUE   // Removes contest ribbons (3 bytes)
#define FREE_POKERUS                        TRUE   // Removes pokerus (1 byte)
#define FREE_LOST_HP                        TRUE   // Removes lost HP, note that putting in PC will restore HP! (2 bytes)
#define FREE_MARKINGS_AND_STATUS            TRUE   // Removes PC markings and compressed status (1 byte)
...
#define FREE_MET_GAME_DYNAMAX_LEVEL         TRUE   // Removes the met game, not needed, and dynamax level (1 byte)
