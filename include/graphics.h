...
extern const u32 gMessageBox_Plat_Gfx[];
extern const u16 gMessageBox_Plat_Pal[];
...
extern const u32 gBattleTerrainTiles_DPPTGrassNight[];
extern const u32 gBattleTerrainPalette_DPPTGrassNight[];
extern const u32 gBattleTerrainTilemap_DPPTGrassNight[];

extern const u32 gBattleTerrainTiles_DPPTGrassAfternoon[];
extern const u32 gBattleTerrainPalette_DPPTGrassAfternoon[];
extern const u32 gBattleTerrainTilemap_DPPTGrassAfternoon[];

extern const u32 gBattleTerrainTiles_DPPTSandDay[];
extern const u32 gBattleTerrainPalette_DPPTSandDay[];
extern const u32 gBattleTerrainTilemap_DPPTSandDay[];
extern const u32 gBattleTerrainAnimTiles_KantoSand[];
extern const u32 gBattleTerrainAnimTilemap_KantoSand[];

extern const u32 gBattleTerrainTiles_DPPTSandAfternoon[];
extern const u32 gBattleTerrainPalette_DPPTSandAfternoon[];
extern const u32 gBattleTerrainTilemap_DPPTSandAfternoon[];

extern const u32 gBattleTerrainTiles_DPPTSandNight[];
extern const u32 gBattleTerrainPalette_DPPTSandNight[];
extern const u32 gBattleTerrainTilemap_DPPTSandNight[];

extern const u32 gBattleTerrainTiles_DPPTWaterDay[];
extern const u32 gBattleTerrainPalette_DPPTWaterDay[];
extern const u32 gBattleTerrainTilemap_DPPTWaterDay[];
extern const u32 gBattleTerrainAnimTiles_KantoWater[];
extern const u32 gBattleTerrainAnimTilemap_KantoWater[];

extern const u32 gBattleTerrainTiles_DPPTWaterAfternoon[];
extern const u32 gBattleTerrainPalette_DPPTWaterAfternoon[];
extern const u32 gBattleTerrainTilemap_DPPTWaterAfternoon[];

extern const u32 gBattleTerrainTiles_DPPTWaterNight[];
...
extern const u32 gBattleTerrainTiles_DPPTPlainDay[];
extern const u32 gBattleTerrainPalette_DPPTPlainDay[];
extern const u32 gBattleTerrainTilemap_DPPTPlainDay[];

extern const u32 gBattleTerrainTiles_DPPTPlainAfternoon[];
extern const u32 gBattleTerrainPalette_DPPTPlainAfternoon[];
extern const u32 gBattleTerrainTilemap_DPPTPlainAfternoon[];

extern const u32 gBattleTerrainTiles_DPPTPlainNight[];
extern const u32 gBattleTerrainPalette_DPPTPlainNight[];
extern const u32 gBattleTerrainTilemap_DPPTPlainNight[];

extern const u32 gBattleTerrainTiles_DPPTForestDay[];
extern const u32 gBattleTerrainPalette_DPPTForestDay[];
extern const u32 gBattleTerrainTilemap_DPPTForestDay[];

extern const u32 gBattleTerrainTiles_DPPTForestAfternoon[];
extern const u32 gBattleTerrainPalette_DPPTForestAfternoon[];
extern const u32 gBattleTerrainTilemap_DPPTForestAfternoon[];

extern const u32 gBattleTerrainTiles_DPPTForestNight[];
extern const u32 gBattleTerrainPalette_DPPTForestNight[];
extern const u32 gBattleTerrainTilemap_DPPTForestNight[];
