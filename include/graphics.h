...
extern const u32 gSignpost_HGSS_Gfx[];
extern const u16 gSignpost_HGSS_Pal[];
...
extern const u32 gBattleTerrainTiles_DPPTSand_Day[];
extern const u32 gBattleTerrainTilemap_DPPTSand_Day[];
extern const u32 gBattleTerrainPalette_DPPTSand_Day[];
extern const u32 gBattleTerrainTiles_DPPTSand_Afternoon[];
extern const u32 gBattleTerrainTilemap_DPPTSand_Afternoon[];
extern const u32 gBattleTerrainPalette_DPPTSand_Afternoon[];
extern const u32 gBattleTerrainTiles_DPPTSand_Night[];
extern const u32 gBattleTerrainTilemap_DPPTSand_Night[];
extern const u32 gBattleTerrainPalette_DPPTSand_Night[];
extern const u32 gBattleTerrainAnimTiles_DPPTSand[];
extern const u32 gBattleTerrainAnimTilemap_DPPTSand[];

extern const u32 gBattleTerrainTiles_DPPTWater_Day[];
extern const u32 gBattleTerrainTilemap_DPPTWater_Day[];
extern const u32 gBattleTerrainPalette_DPPTWater_Day[];
...
extern const u32 gBattleTerrainTiles_DPPTMountain_Day[];
extern const u32 gBattleTerrainTilemap_DPPTMountain_Day[];
extern const u32 gBattleTerrainPalette_DPPTMountain_Day[];
extern const u32 gBattleTerrainTiles_DPPTMountain_Afternoon[];
extern const u32 gBattleTerrainTilemap_DPPTMountain_Afternoon[];
extern const u32 gBattleTerrainPalette_DPPTMountain_Afternoon[];
extern const u32 gBattleTerrainTiles_DPPTMountain_Night[];
extern const u32 gBattleTerrainTilemap_DPPTMountain_Night[];
extern const u32 gBattleTerrainPalette_DPPTMountain_Night[];
...
extern const u32 gBattleTerrainTiles_DPPTIndoor_1[];
extern const u32 gBattleTerrainTilemap_DPPTIndoor_1[];
extern const u32 gBattleTerrainPalette_DPPTIndoor_1[];
extern const u32 gBattleTerrainTiles_DPPTIndoor_2[];
extern const u32 gBattleTerrainTilemap_DPPTIndoor_2[];
extern const u32 gBattleTerrainPalette_DPPTIndoor_2[];
extern const u32 gBattleTerrainAnimTiles_DPPTIndoor[];
extern const u32 gBattleTerrainAnimTilemap_DPPTIndoor[];

extern const u32 gBattleTerrainTiles_DPPTWetPath_Day[];
extern const u32 gBattleTerrainTilemap_DPPTWetPath_Day[];
extern const u32 gBattleTerrainPalette_DPPTWetPath_Day[];
extern const u32 gBattleTerrainTiles_DPPTWetPath_Afternoon[];
extern const u32 gBattleTerrainTilemap_DPPTWetPath_Afternoon[];
extern const u32 gBattleTerrainPalette_DPPTWetPath_Afternoon[];
extern const u32 gBattleTerrainAnimTiles_DPPTWetPath[];
extern const u32 gBattleTerrainAnimTilemap_DPPTWetPath[];
